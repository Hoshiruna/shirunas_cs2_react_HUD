export const panelDefinition = [
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "type": "text",
        "name": "matchbar_left_logo_background_color",
        "label": "Matchbar left logo background color"
      },
      {
        "type": "text",
        "name": "matchbar_right_logo_background_color",
        "label": "Matchbar right logo background color"
      },
      {
        "type": "text",
        "name": "radar_tournament_title",
        "label": "Radar tournament title"
      },
      {
        "type": "text",
        "name": "radar_tournament_stage",
        "label": "Radar tournament stage"
      },
      {
        "type": "select",
